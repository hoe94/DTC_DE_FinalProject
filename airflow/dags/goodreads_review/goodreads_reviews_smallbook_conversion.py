...
with DAG(
    dag_id = "goodreads_reviews_smallbook_conversion",
    ...
    convert_json_csv_children = PythonOperator(
        ...
        op_kwargs = {
            "json_file": airflow_home + '/goodreads_reviews_children.json',
            "csv_file": airflow_home + '/goodreads_reviews_children.csv',
            "bucket": BUCKET,
            "object_name": "raw/goodreads_reviews_children.csv",
            "local_file": "goodreads_reviews_children.csv"
        }
    )
    ...
    convert_json_csv_graphic = PythonOperator(
        ...
        python_callable = convert_json_csv_books,
        op_kwargs = {
            "json_file": airflow_home + '/goodreads_reviews_comics_graphic.json',
            "csv_file": airflow_home + '/goodreads_reviews_comics_graphic.csv',
            "bucket": BUCKET,
            "object_name": "raw/goodreads_reviews_comics_graphic.csv",
            "local_file": "goodreads_reviews_comics_graphic.csv"
        }
    )
    ...
    convert_json_csv_poetry = PythonOperator(
        ...
        python_callable = convert_json_csv_books,
        op_kwargs = {
            "json_file": airflow_home + '/goodreads_reviews_poetry.json',
            "csv_file": airflow_home + '/goodreads_reviews_poetry.csv',
            "bucket": BUCKET,
            "object_name": "raw/goodreads_reviews_poetry.csv",
            "local_file": "goodreads_reviews_poetry.csv"
        }
    )
    ...
    convert_json_csv_young_adult = PythonOperator(
        ...
        python_callable = convert_json_csv_books,
        op_kwargs = {
            "json_file": airflow_home + '/goodreads_reviews_young_adult.json',
            "csv_file": airflow_home + '/goodreads_reviews_young_adult.csv',
            "bucket": BUCKET,
            "object_name": "raw/goodreads_reviews_young_adult.csv",
            "local_file": "goodreads_reviews_young_adult.csv"
        }
    )
