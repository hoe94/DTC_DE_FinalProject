...
json_file_list = airflow_home + '/goodreads_books_mystery_thriller_crime.json',
csv_file_list = airflow_home + '/goodreads_books_mystery_thriller_crime.csv',
...
with DAG(
    dag_id = "goodreads_books_mystery_thriller_crime_conversion",
    ...
    convert_json_csv_mystery_thriller_crime = PythonOperator(
        ...
        op_kwargs = {
            "json_file": airflow_home + '/goodreads_books_mystery_thriller_crime.json',
            "csv_file": airflow_home + '/goodreads_books_mystery_thriller_crime.csv',
            "bucket": BUCKET,
            "object_name": "raw/goodreads_books_mystery_thriller_crime.csv",
            "local_file": "goodreads_books_mystery_thriller_crime.csv"
        }
    )
